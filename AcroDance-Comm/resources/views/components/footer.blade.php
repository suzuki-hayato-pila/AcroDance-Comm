...
<div class="fixed bottom-0 w-full bg-blue-900 p-4 flex justify-around text-white">
    <a href="{{ route('home') }}" class="text-center hover:text-yellow-200">
        <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l9-9m0 0l9 9m-9-9v18"></path>
        </svg>
        <span class="text-xs">ホーム</span>
    </a>
    <a href="{{ route('search') }}" class="text-center hover:text-yellow-200">
        <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
        </svg>
        <span class="text-xs">投稿一覧</span>
    </a>
    <a href="{{ route('profile.edit') }}" class="text-center hover:text-yellow-200">
        <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-9m-9 9l-9-9m9 9v10"></path>
        </svg>
        <span class="text-xs">マイページ</span>
    </a>
    <a href="{{ route('posts.create') }}" class="text-center hover:text-yellow-200">
        <svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"></path>
        </svg>
